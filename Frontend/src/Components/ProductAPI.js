...
function ProductAPI() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        // const response = await axios.get('http://localhost:5000/api/products/Hoodie');
        const response = await axios.get(`${process.env.REACT_APP_PRODUCT_API_BASE_URL}/api/products/Hoodie`);
            ...
            <div className="section-title">
              ...
              <div className="section-nav">
                <ul className="section-tab-nav tab-nav">
                  <li className="active"><Link to="/hoodie">Hoodie</Link></li>
